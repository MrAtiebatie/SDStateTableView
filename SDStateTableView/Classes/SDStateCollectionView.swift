//
//  SDStateCollectionView.swift
//  SDStateCollectionView
//
//  Created by Sauvik Dolui on 13/10/17.
//

import Foundation
public enum SDStateCollectionViewState {
    case dataAvailable
...
public class SDStateCollectionView: UITableView {
    ...
    public var currentState: SDStateCollectionViewState = .unknown {
        didSet {
            if case SDStateCollectionViewState.dataAvailable  = self.currentState {
    ...
    private func setUp() {
        ...
        //
        if case SDStateCollectionViewState.withButton(_, _, _, _, _, _) = currentState {
    ...
    public func setState(_ state: SDStateCollectionViewState) {
